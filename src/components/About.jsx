...
<div className="relative">
      ...
      >
        <source src="https://ik.imagekit.io/tedxvjit/public/about/about_us.mp4?updatedAt=1729522798008" type="video/mp4" />
          ...
          <div className="container mx-auto p-4 md:p-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-12 px-4">
              ...
              <div className="md:order-2 md:w-1/2 border-2 border-red-500 inline-block mr-3 mt-5 mb-10">
                <img className="img-fluid w-full mx-auto" src="https://ik.imagekit.io/tedxvjit/public/about/Tedx1.jpg?updatedAt=1729522785303" alt="Theme" />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-12 px-4 mt-10">
              ...
              <div className="md:order-1 md:w-1/2 border-2 border-red-500 inline-block mr-3 mt-5 mb-10">
                <img className="img-fluid w-full mx-auto" src='https://ik.imagekit.io/tedxvjit/public/about/Tedx2.png?updatedAt=1729522786214' alt="Motto" />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-12 px-4">
              ...
              <div className="md:order-2 md:w-1/2 border-2 border-red-600  inline-block mr-3 mt-5 mb-10">
                <img className="img-fluid w-full mx-auto " src="/e block.jpg" alt="Vision" />
              </div>
            </div>
